...
class DirectRunnerSourceGenerator {
  ...
  String generate(
    ...
    buffer
      ...
      ..writeln(
        '  configureBenchmarkRunner(emitJsonlResults: true, profileMode: $profileMode, timeoutMultiplier: 1);',
      )
  ...
  String generateNodeBootstrap(
    ...
    buffer
      ..writeln('Future<void> main() async {')
      ..writeln(
        '  configureBenchmarkRunner(emitJsonlResults: true, profileMode: $profileMode, timeoutMultiplier: 3);',
      )
      ..writeln('  try {');
    for (var i = 0; i < testFiles.length; i++) {
      buffer.writeln('    await Future.sync(test_$i.main);');
